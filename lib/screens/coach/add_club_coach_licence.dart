...
class AddClubCoachLicenceScreen extends StatefulWidget{
  @override
  State<AddClubCoachLicenceScreen> createState() => _AddClubCoachLicenceScreenState();
}

class _AddClubCoachLicenceScreenState extends State<AddClubCoachLicenceScreen> {
  ...
  void initState() {
    ...
    clubs=licenceController.getCoachClubs();
    super.initState();
  }
  @override
                    ...
                    child: FloatingActionButton.extended(
                      onPressed: () {
                        ...
                        // if((licenceController.currentUser.club!.id==null)){
                          ...
                          licenceController.assignClubToCoach(context);
