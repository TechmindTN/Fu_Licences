...
class AddDefaultCoachScreen extends StatefulWidget {
  const AddDefaultCoachScreen({super.key});

  @override
  State<AddDefaultCoachScreen> createState() => _AddDefaultCoachScreenState();
}

class _AddDefaultCoachScreenState extends State<AddDefaultCoachScreen> {
  // String? categoryId;
  // dynamic? gradeId;
  // dynamic? idDegree;
  // int? discipline;
                    ...
                    child: FloatingActionButton.extended(
                      onPressed: () {
                        ...
                        ////print(licenceController.selectedWeight!.id);
                          ...
                          licenceController.createDefaultCoach(context);
