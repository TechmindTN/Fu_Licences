...
class AddDefaultProfileScreen extends StatefulWidget {
  const AddDefaultProfileScreen({super.key});

  @override
  State<AddDefaultProfileScreen> createState() => _AddDefaultProfileScreenState();
}

class _AddDefaultProfileScreenState extends State<AddDefaultProfileScreen> {
                    ...
                    child: FloatingActionButton.extended(
                      onPressed: () {
                        if (
                          ...
                          licenceController.createDefaultCoachProfile(
                          ...
                          GoRouter.of(context)
                             .push(Routes.AddDefaultCoachLicence);
